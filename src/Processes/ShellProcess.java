...
public abstract class ShellProcess {
	...
	// Process tied to this Shell Process, null if not yet executed by SProcessExecutor.
	...
	//Buffered readers for the process stdstderrorout and stderror.
	 ...
	 * 
	 */
	public abstract ShellProcessImpl.OS getOSType();
